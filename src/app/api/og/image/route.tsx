...
const themeSearchParamSchema = z.enum(["tdg", "dark"]);

type Theme = z.infer<typeof themeSearchParamSchema>;
...
const searchParamsSchema = z.object({
  content: z.string(),
  template: themeSearchParamSchema.optional(),
  theme: themeSearchParamSchema.optional(),
...
export async function GET(request: Request) {
  ...
  const themeData = getDataForTheme(theme ?? template);
